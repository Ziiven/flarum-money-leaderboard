          ...
          <div className="sideNavContainer">
            ...
            <div class="MoneyLeaderboardContainer">
              ...
              {!this.loading && this.moneyLeaderboardList.length===0 && (
                <div>
                  <div style="font-size:1.4em;color: var(--muted-more-color);text-align: center;height: 300px;line-height: 100px;">{app.translator.trans("ziven-money-leaderboard.forum.transfer-list-empty")}</div>
                </div>
              )}
